      ...
      <div className="flex-1 max-w-xl mx-auto">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-2.5 rounded-xl bg-white/10 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-musify-teal/50 border border-transparent"
          />
